...
import com.mylocals.db.RestaurantDBHelper;
import com.mylocals.models.Restaurant;
import com.mylocals.utils.SavedListHolder;
...
public class MainRestaurantCardAdapter extends RecyclerView.Adapter<MainRestaurantCardAdapter.RestaurantViewHolder> {
    ...
    public MainRestaurantCardAdapter(AppCompatActivity con, Restaurant res) {
        this.context = (AppCompatActivity) con;
        this.restaurant = res;
